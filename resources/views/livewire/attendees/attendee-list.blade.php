<div class="space-y-8 font-inter">
    ...
    <div class="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
        ...
        <div class="grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-start xl:justify-end gap-2 sm:gap-2.5 shrink-0 w-full xl:w-auto">
            <!-- Export CSV -->
            <button wire:click="export" class="px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 hover:bg-slate-50 dark:hover:bg-white/10 text-slate-700 dark:text-slate-200 text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer shrink-0">
