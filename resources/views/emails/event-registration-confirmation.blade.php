...
<head>
    ...
    <style>
        ...
        .progress-bar-fill {
            height: 100%;
            background: linear-gradient(90deg, #3b82f6 0%, #818cf8 50%, #34d399 100%);
            border-radius: 9999px;
        }
    ...
    <div class="wrapper">
        <div class="container">
            <div class="header">
                ...
                <p>Thank you for registering with AttendFlow</p>
            </div>
            
            <div class="content">
                <div class="greeting">Hello {{ $attendee->full_name }},</div>
                <div class="message">
                    Your registration for <strong style="color: #ffffff;">{{ $event->name }}</strong> has been successfully received. Below are your registration details and event summary.
                </div>
                ...
                <div class="card">
                    <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                            <td class="card-label">Attendee Email</td>
                            <td class="card-value">{{ $attendee->email }}</td>
                        </tr>
                        <tr>
            ...
            <div class="footer">
                ...
                If you did not register for this event, please disregard this email.
            </div>
        </div>
    </div>
</body>
